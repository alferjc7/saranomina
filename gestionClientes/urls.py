...
urlpatterns = [
    ...
    path("clientes/<int:id>/empresas/", empresasCreateView.as_view(), name="empresas"),
    path("clientes/<int:id>/empresa_eliminar/<int:pk>/", empresasDeleteView.as_view(), name="empresa_eliminar"),
